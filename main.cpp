...
int main(int argc, char *argv[])
{
    ...
    QFile file("G:/QT/Examples/Qt-5.14.2/location/build-mapviewer-Desktop_Qt_5_14_2_MSVC2017_64bit-Debug/debug/s.json");
        if (!file.open(QIODevice::ReadOnly | QIODevice::Text))return 0;
        QTextStream in(&file);
        QString line = in.readAll();
        file.close();
        engine.rootContext()->setContextProperty("file",line);
